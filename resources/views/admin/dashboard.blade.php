                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/toolbox.svg" alt="Toolbar svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/parachute.svg" alt="Parachute svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/brush.svg" alt="Brush svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/star.svg" alt="Star svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/book.svg" alt="Book svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/rocket.svg" alt="Rocket svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar rounded">
                                                        <div class="avatar-content">
                                                            <img src="{{asset('adminAsset')}}/images/icons/speaker.svg" alt="Speaker svg" />
                                                        </div>
                                                    </div>
                                                    <div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card card-developer-meetup">
                            <div class="meetup-img-wrapper rounded-top text-center">
                                <img src="{{asset('adminAsset')}}/images/illustration/email.svg" alt="Meeting Pic" height="170" />
                            </div>
                            <div class="card-body">
                                ...
                                <div class="avatar-group">
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Billy Hopkins" class="avatar pull-up">
                                        <img src="{{asset('adminAsset')}}/images/portrait/small/avatar-s-9.jpg" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Amy Carson" class="avatar pull-up">
                                        <img src="{{asset('adminAsset')}}/images/portrait/small/avatar-s-6.jpg" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Brandon Miles" class="avatar pull-up">
                                        <img src="{{asset('adminAsset')}}/images/portrait/small/avatar-s-8.jpg" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-toggle="tooltip" data-popup="tooltip-custom" data-placement="bottom" data-original-title="Daisy Weber" class="avatar pull-up">
                                        <img src="{{asset('adminAsset')}}/images/portrait/small/avatar-s-20.jpg" alt="Avatar" width="33" height="33" />
                                    </div>
                        ...
                        <div class="card card-browser-states">
                            ...
                            <div class="card-body">
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="{{asset('adminAsset')}}/images/icons/google-chrome.png" class="rounded mr-1" height="30" alt="Google Chrome" />
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="{{asset('adminAsset')}}/images/icons/mozila-firefox.png" class="rounded mr-1" height="30" alt="Mozila Firefox" />
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="{{asset('adminAsset')}}/images/icons/apple-safari.png" class="rounded mr-1" height="30" alt="Apple Safari" />
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="{{asset('adminAsset')}}/images/icons/internet-explorer.png" class="rounded mr-1" height="30" alt="Internet Explorer" />
                                ...
                                <div class="browser-states">
                                    <div class="media">
                                        <img src="{{asset('adminAsset')}}/images/icons/opera.png" class="rounded mr-1" height="30" alt="Opera Mini" />
