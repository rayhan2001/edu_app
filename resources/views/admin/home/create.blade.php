...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-3 shadow-sm rounded" style="border: none;">
                    <div class="card-title">Add Home Content</div>
                    <form method="post" id="homeForm" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sub_title" name="sub_title" class="form-control" placeholder="Your Sub Title">
    ...
    <script>
        ...
        $('#submit-button').click(function(e){
            ...
            data.append('sub_title', document.getElementById("sub_title").value);
