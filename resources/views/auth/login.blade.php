...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('adminAsset')}}/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="{{asset('adminAsset')}}/css/pages/page-auth.css">
    <!-- END: Page CSS-->
            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{asset('adminAsset')}}/images/pages/login-v2.svg" alt="Login V2" /></div>
                    </div>
                    <!-- /Left Text-->
                    <!-- Login-->
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary btn-block mt-3" tabindex="4">Sign in</button>
                            </form>
...
<script src="{{asset('adminAsset')}}/vendors/js/forms/validation/jquery.validate.min.js"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="{{asset('adminAsset')}}/js/scripts/pages/page-auth-login.js"></script>
<!-- END: Page JS-->
