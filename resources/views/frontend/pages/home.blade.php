...
@section('content')
    ...
    <div class="urgent-cause-area overlay bgs-cover pt-120 pb-90 rel z-1"
            ...
            <div class="row gap-40">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="cause-item">
                        <div class="image">
                            <img src="{{asset('frontendAsset')}}/img/causes/cause1.jpg" alt="Cause">
                        </div>
                        <div class="content">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="cause-item">
                        <div class="image">
                            <img src="{{asset('frontendAsset')}}/img/causes/cause2.jpg" alt="Cause">
                        </div>
                        <div class="content">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="cause-item">
                        <div class="image">
                            <img src="{{asset('frontendAsset')}}/img/causes/cause3.jpg" alt="Cause">
                        </div>
                        <div class="content">
        ...
        <div class="urgent-cause-shapes">
            <img class="one top_image_bounce" src="{{asset('frontendAsset')}}/img/shapes/half-circle-with-dots.png" alt="Shape">
            <img class="two left_image_bounce" src="{{asset('frontendAsset')}}/img/shapes/circle-with-line-red.png" alt="Shape">
            <img class="three right_image_bounce" src="{{asset('frontendAsset')}}/img/shapes/circle-with-line-green.png" alt="Shape">
        </div>
    </div>
    ...
    <div class="our-cause-area pt-120 pb-90 rel z-1">
        ...
        <div class="our-cause-shapes">
            <img class="one top_image_bounce" src="{{asset('frontendAsset')}}/img/shapes/three-round-green.png" alt="Shape">
        </div>
    </div>
    <!-- Our cause area end -->
    ...
    <div class="features-area rel bgs-cover z-1" style="background-image: url(assets/img/background/feature-bg.jpg);">
        ...
        <div class="feature-shapes">
            <img class="one right_image_bounce" src="{{asset('frontendAsset')}}/img/shapes/three-round-green.png" alt="Shape">
        </div>
    </div>
    <!-- Features area end -->
    ...
    <div class="become-volunteer-area py-120 overflow-hidden rel z-1">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="volunteer-image rmb-65">
                        <img src="{{asset('frontendAsset')}}/img/valunteer/valunteer-left.png" alt="valunteer">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="become-volunteer-shapes">
            <img class="one" src="{{asset('frontendAsset')}}/img/valunteer/valunteer-bg.png" alt="Shape">
            <img class="two" src="{{asset('frontendAsset')}}/img/valunteer/valunteer-bg.png" alt="Shape">
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 col-sm-6">
                    <div class="valunteer-item valunteer-item--green">
                        <div class="valunteer-item__img">
                            <img src="{{asset('frontendAsset')}}/img/valunteer/valunteer1.jpg" alt="Valunteer">
                            <div class="share">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="valunteer-item">
                        <div class="valunteer-item__img">
                            <img src="{{asset('frontendAsset')}}/img/valunteer/valunteer2.jpg" alt="Valunteer">
                            <div class="share">
                                <button><i class="flaticon-share"></i></button>
                                <div class="share__socials">
                                    <a href="#"><i class="flaticon-google-plus-logo"></i></a>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="valunteer-item valunteer-item--yellow">
                        <div class="valunteer-item__img">
                            <img src="{{asset('frontendAsset')}}/img/valunteer/valunteer3.jpg" alt="Valunteer">
                            <div class="share">
                                <button><i class="flaticon-share"></i></button>
                                <div class="share__socials">
                                    <a href="#"><i class="flaticon-google-plus-logo"></i></a>
            ...
            <div class="row gap-100 align-items-center">
                <div class="col-lg-5">
                    <div class="testimonial-left-image rmb-65">
                        <img src="{{asset('frontendAsset')}}/img/testimonials/testimonial-left.png" alt="Testimonials">
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <div class="testimonial-thumb-slider">
                        <div class="testimonial-thumb-item">
                            <img src="{{asset('frontendAsset')}}/img/testimonials/testi-thumb1.jpg" alt="Author">
                        </div>
                        <div class="testimonial-thumb-item">
                            <img src="{{asset('frontendAsset')}}/img/testimonials/testi-thumb2.jpg" alt="Author">
                        </div>
                        <div class="testimonial-thumb-item">
                            <img src="{{asset('frontendAsset')}}/img/testimonials/testi-thumb3.jpg" alt="Author">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-6">
                                <div class="image">
                                    ...
                                    <img class="shape one top_image_bounce"
                                         src="{{asset('frontendAsset')}}/img/shapes/three-round-green.png" alt="Shape">
                                </div>
                                <div class="image">
                                    <img src="{{asset('frontendAsset')}}/img/about/about3.jpg" alt="About">
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="image">
                                    ...
                                    <img class="shape two right_image_bounce"
                                         src="{{asset('frontendAsset')}}/img/shapes/three-round-red.png" alt="Shape">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="client-logo-wrap">
                <div class="client-logo-item">
                    <a href="#"><img src="{{asset('frontendAsset')}}/img/client-logo/client-logo1.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item">
                    <a href="#"><img src="{{asset('frontendAsset')}}/img/client-logo/client-logo2.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item">
                    <a href="#"><img src="{{asset('frontendAsset')}}/img/client-logo/client-logo3.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item">
                    <a href="#"><img src="{{asset('frontendAsset')}}/img/client-logo/client-logo4.png" alt="Client Logo"></a>
                </div>
                <div class="client-logo-item">
                    <a href="#"><img src="{{asset('frontendAsset')}}/img/client-logo/client-logo5.png" alt="Client Logo"></a>
                </div>
            </div>
        </div>
    </div>
